...
public final class CachedResponseDao_Impl implements CachedResponseDao {
  ...
  @Override
  public Object upsert(final CachedResponse e, final Continuation<? super Unit> $completion) {
  ...
  @Override
  public Object deleteOlderThan(final long olderThanMs,
  ...
  @Override
  public Object byKey(final String key, final Continuation<? super CachedResponse> $completion) {
    ...
    return CoroutinesRoom.execute(__db, false, _cancellationSignal, new Callable<CachedResponse>() {
      @Override
      @Nullable
  ...
  @Override
  public Object lruKeys(final int limit, final Continuation<? super List<String>> $completion) {
  ...
  @Override
  public Object totalBytes(final Continuation<? super Long> $completion) {
  ...
  @Override
  public Object deleteByKeys(final List<String> keys,
      final Continuation<? super Integer> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Integer>() {
      @Override
      @NonNull
